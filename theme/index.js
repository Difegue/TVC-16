...
imgArray[0].src = '/theme/img/symbol.svg';

imgArray[1] = new Image();
imgArray[1].src = '/theme/img/symbol2.svg';

imgArray[2] = new Image();
imgArray[2].src = '/theme/img/symbol3.svg';

imgArray[3] = new Image();
imgArray[3].src = '/theme/img/symbol4.svg';

imgArray[4] = new Image();
imgArray[4].src = '/theme/img/symbol5.svg';

imgArray[5] = new Image();
imgArray[5].src = '/theme/img/symbol6.svg';

imgArray[6] = new Image();
imgArray[6].src = '/theme/img/symbol7.svg';

imgArray[7] = new Image();
imgArray[7].src = '/theme/img/symbol8.svg';

imgArray[8] = new Image();
imgArray[8].src = '/theme/img/symbol9.svg';

imgArray[9] = new Image();
imgArray[9].src = '/theme/img/symbol10.svg';

imgArray[10] = new Image();
imgArray[10].src = '/theme/img/symbol11.svg';

imgArray[11] = new Image();
imgArray[11].src = '/theme/img/symbol12.svg';

imgArray[12] = new Image();
imgArray[12].src = '/theme/img/symbol13.svg';

imgArray[13] = new Image();
imgArray[13].src = '/theme/img/cart2.svg';
...
kofiWidgetOverlay.draw('difegue', {
  'type': 'floating-chat',
